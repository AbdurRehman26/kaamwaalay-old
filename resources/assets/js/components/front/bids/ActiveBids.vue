			...
			<div class="job-post-details">
				...
				<div class="job-common-description job-perform">
					...
					<div class="col-md-6 job-bid-btn p-r-0">
						<a href="javascript:void(0);" @click="$emit('chatmessage', record, 'strictChat')" class="chat-message" :class="{disable: record.job.can_message? false : true}"><i class="icon-message"></i></a>						
