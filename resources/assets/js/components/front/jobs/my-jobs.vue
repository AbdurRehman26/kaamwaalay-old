		...
		<div class="container">
			...
			<div class="job-post-container section-padd sm">
				<div class="container md">
					...
					<div class="job-post-list" v-for="record in records">
						<div class="job-post-details">
							<div class="job-image pointer" @click="servicedetail" v-bind:style="{'background-image': 'url('+ record.user.profile_image +')',}"></div>

							<div class="job-common-description job-perform">
								<div class="col-md-6 p-l-0">
									<h3 class="pointer" @click="servicedetail">{{record.title}}</h3> 
                                    <!-- <span><i class="icon-checked"></i></span> -->
                                    <div class="job-notification">									
                                      <div class="jobs-done">
                                         <span class="job-category">{{ record.service ? record.service.title : '' }}</span>		
                ...
                <div class="job-details">
                    <p class="bid">
                     <i class="icon-flag"></i> 
                     <strong>{{ record.bids_count }} bids received - <a href="javascript:void(0);" @click="servicedetail">View Bids</a></strong>
                 </p>
