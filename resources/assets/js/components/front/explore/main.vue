        	...
        	<div class="container">
	        	...
	        	<div class="category-section" v-for="maincategory in category">
	        		...
	        		<div class="category-items">
		        		...
		        		<div class="showmore showmore-link clearfix"><a href="javascript:void(0);">View all services related to electricians <i class="icon-keyboard_arrow_right"></i></a></div>
