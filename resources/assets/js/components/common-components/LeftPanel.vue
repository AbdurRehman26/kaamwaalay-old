<template>
        <div class="left-menu-panel">
            ...
            <nav class="main-nav">
                <ul>
                    <li class=""><router-link to="/dashboard"><i class="icon-speedometer" aria-hidden="true"></i><span>Dashboard</span></router-link></li>
                    <li class=""><router-link to="/service-type"><i class="icon-tools-2" aria-hidden="true"></i><span>Service / Sub Service</span></router-link></li>
                    <li class=""><router-link to="/customer"><i class="icon-users" aria-hidden="true"></i><span>Customer</span></router-link></li>
                    <li class=""><router-link to="/service-provider"><i class="icon-handshake-o" aria-hidden="true"></i><span>Service Provider</span></router-link></li>
                    <li class=""><router-link to="/service-provider-review"><i class="icon-star_border" aria-hidden="true"></i><span>Service Provider Review</span></router-link></li>
