                ...
                <div class="col-xs-12 block-area">
                    ...
                    <div class="view-details-list">
                        ...
                        <b-row>
                            ...
                            <b-col class="calculated-value">
                                <star-rating :star-size="20" :increment="0.02" read-only :rating="records.user_detail ? parseInt(records.user_detail.average_rating) : 0" active-color="#00B389"></star-rating>
                            </b-col>
                        </b-row>                                                                   
                        <b-row>
                            <b-col  class="text-right fixed-label">
