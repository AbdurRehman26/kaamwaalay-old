<template>
    <div>
        ...
        <div slot="modal-footer" class="w-100 frontfix">
            <div class="row">
                <button @click.prevent="submitForm" :class="[loading  ? 'show-spinner' : '' , 'btn' , 'btn-primary' , 'apply-primary-color' ,'col-sm-3', ]">Yes
                    <loader></loader>
                </button>
                <button @click.prevent="submitForm" :class="[loading  ? 'show-spinner' : '' , 'btn' , 'btn-link' , 'apply-primary-color' ,'col-sm-3' ]">
                    No
                    <loader></loader>
                </button>
            </div>
