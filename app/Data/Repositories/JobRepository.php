    ...
    public function findById($id, $refresh = false, $details = false, $encode = true)
    {
        ...
        if ($data) {
            ...
            if (empty($details['job_details'])) {
                ...
                $service_provider_count = User::join(
            ...
            ->join(
                ...
                function ($joins) use ($data) {
                    $joins->on('service_provider_services.service_provider_profile_id', '=', 'service_provider_profiles'.'.id');
                    $joins->where('service_provider_services.service_id', '=', $data->service_id);
                }
