...
use App\Services\Customer\JobBidService;
use App\Http\Resources\API\Customer\JobBid\JobBidCollectionResource;

class JobBidController extends ApiResourceController
{
    public $_repository;
    public $jobBidService;

    public function __construct(JobBidRepository $repository, JobBidService $jobBidService)
    {
    ...
    {
        return new JobBidCollectionResource($this->jobBidService->getJobBids($request->filter));
    }
